...
Для кода в `assas.py` теперь ориентиром служит документация API Cryptura:
- `https://cryptura.gitbook.io/cryptura-docs`
- базовый URL в коде: `https://cryptura.space/api` (и тестовый `https://cryptura.space/api-test`)
